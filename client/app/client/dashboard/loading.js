  ...
  return (
    <div className="min-h-screen bg-background p-6 animate-pulse">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="h-7 w-36 bg-muted rounded-lg"></div>
      ...
      <div className="rounded-lg border bg-card shadow-sm p-6 mb-6">
        <div className="h-6 w-52 bg-muted rounded-lg mb-4"></div>
        <div className="h-4 w-36 bg-muted rounded mb-6"></div>
      ...
      <div className="flex flex-col gap-3">
        {[...Array(4)].map((_, i) => (
          <div key={i} className="rounded-lg border bg-card shadow-sm p-4">
            ...
            {[...Array(2)].map((_, j) => (
              <div key={j} className="h-8 bg-muted rounded mb-2"></div>
            ))}
          </div>
        ))}
      </div>
