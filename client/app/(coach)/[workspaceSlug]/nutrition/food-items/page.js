...
function FoodForm({ data, onChange, onSubmit, onCancel, submitLabel, isEdit, categories, t, tCommon }) {
    ...
    return (
        <div className="p-8 flex flex-col gap-6">
            ...
            <Modal open={showForm} onClose={() => { setShowForm(false); setFormData(emptyForm); }} title={t("addTitle")}>
                <FoodForm data={formData} onChange={handleChange} onSubmit={handleSubmit} onCancel={() => { setShowForm(false); setFormData(emptyForm); }} submitLabel={t("submitAdd")} categories={categories} t={t} tCommon={tCommon} />
            </Modal>

            <Modal open={!!editingItem} onClose={() => setEditingItem(null)} title={t("editTitle")}>
                <FoodForm data={editingItem || emptyForm} onChange={handleEditChange} onSubmit={handleUpdate} onCancel={() => setEditingItem(null)} submitLabel={t("submitEdit")} isEdit categories={categories} t={t} tCommon={tCommon} />
            </Modal>
