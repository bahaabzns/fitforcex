...
export default function ClientLayout({ children }) {
    ...
    const tabs = [
        { name: "Overview",      href: `/${workspaceSlug}/clients/${id}` },
        { name: "Nutrition",     href: `/${workspaceSlug}/clients/${id}/nutrition` },
        { name: "Training",      href: `/${workspaceSlug}/clients/${id}/training` },
        { name: "Forms",         href: `/${workspaceSlug}/clients/${id}/forms` },
        { name: "Transactions",  href: `/${workspaceSlug}/clients/${id}/transactions` },
    ];
