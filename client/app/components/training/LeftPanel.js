                                            ...
                                            return (
                                                <div
                                                    ...
                                                    className={`group flex items-center gap-3 rounded-xl px-3 py-2.5 cursor-pointer select-none shadow-surface transition-all duration-150 ${
                                                        isActive ? "bg-primary/5 dark:bg-(--color-surface-secondary) ring-1 ring-primary/40" : "bg-card dark:bg-(--color-surface-secondary) hover:ring-1 hover:ring-primary/20"
                                                    }`}
                                                >
