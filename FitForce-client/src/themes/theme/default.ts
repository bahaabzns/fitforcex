...
export default function Default(mode: ThemeMode): PaletteThemeProps {
  ...
  let primaryColors = ['#E6F3FF', '#CCE7FF', '#99CFFF', '#66B7FF', '#4DAFFF', '#159BFF', '#0D7AE8', '#0B5FCC', '#0844B0', '#062993'];
  ...
  if (mode === ThemeMode.DARK) {
    primaryColors = ['#062993', '#0844B0', '#0B5FCC', '#0D7AE8', '#159BFF', '#4DAFFF', '#66B7FF', '#99CFFF', '#CCE7FF', '#E6F3FF'];
