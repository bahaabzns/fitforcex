    ...
    >
      ...
      <div className="section-container relative z-10">
        ...
        <div className="text-center mb-12 pb-12 border-b border-cyan-500/20">
          <h3 className="text-2xl md:text-3xl font-black text-[var(--text-primary)] mb-4">Ready to Transform Your Coaching Business?</h3>
          <p className="text-[var(--text-secondary)] mb-6 max-w-2xl mx-auto">
            Join 10,000+ coaches who trust FitForce to manage their clients and grow their business
          </p>
          ...
          <p className="text-sm text-gray-500 mt-4">✓ No credit card required • ✓ Cancel anytime • ✓ 30-day money-back guarantee</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            <div className="text-2xl font-black text-[var(--text-primary)] mb-4 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
              FitForce
            </div>
            <p className="text-[var(--text-tertiary)] mb-4">{t.footer.tagline}</p>
            <LanguageToggle />
          </div>

          {/* Product */}
          <div>
            <h3 className="text-[var(--text-primary)] font-bold mb-4">{t.footer.product}</h3>
          ...
          {/* Company */}
          <div>
            <h3 className="text-[var(--text-primary)] font-bold mb-4">{t.footer.company}</h3>
            <ul className="space-y-2">
          ...
          {/* Support */}
          <div>
            <h3 className="text-[var(--text-primary)] font-bold mb-4">{t.footer.support}</h3>
            <ul className="space-y-2">
          ...
          {/* Legal */}
          <div>
            <h3 className="text-[var(--text-primary)] font-bold mb-4">{t.footer.legal}</h3>
            <ul className="space-y-2">
              {legalLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="hover:text-cyan-400 transition-colors duration-300">
        ...
        <div className="border-t border-cyan-500/20 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            <a href={`mailto:${t.footer.email}`} className="text-sm hover:text-cyan-400 transition-colors duration-300">
              {t.footer.email}
            </a>
