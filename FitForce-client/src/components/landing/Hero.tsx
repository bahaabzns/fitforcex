...
export default function Hero() {
  ...
  }, [activeIndex, workflowDescriptions]);
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          >
            <div className="mb-0 max-w-5xl">
              ...
              >
                ...
                <span className="text-xs font-semibold text-cyan-300 tracking-wide">
                  {t?.hero?.superSheetsBadge ??
                    (dir === "rtl"
                      ? 'الجيل الجديد من "Super Sheets"'
                      : 'The new generation of "Super Sheets"')}
                </span>
              </div>

              <h1
                className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-[var(--text-primary)] mb-4 sm:mb-6 leading-[1.1] tracking-tight transition-all duration-500 delay-75 ${
                  isVisible
                    ? "opacity-100 translate-y-0"
                    : "opacity-0 translate-y-10"
                }`}
              ...
              {/* Social Proof Stats placeholder (visible) */}
          ...
          >
            ...
            <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl bg-black/40 backdrop-blur-xl border-2 border-cyan-500/30 transition-all duration-300">
              <div className="px-4 py-3 sm:px-6 sm:py-4 md:px-8 md:py-5">
                ...
                <p
                  className={`text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-cyan-300 to-blue-400 bg-clip-text text-transparent min-h-[1.75rem] sm:min-h-[2rem] md:min-h-[2.5rem] flex items-start leading-tight flex-1 ${
                ...
                >
                  ...
                  <span
                    className={`inline-block w-1.5 sm:w-2 h-4 sm:h-5 md:h-6 lg:h-7 bg-cyan-400 animate-pulse flex-shrink-0 ${
                      dir === "rtl" ? "mr-1 sm:mr-1.5" : "ml-1 sm:ml-1.5"
                    }`}
                    aria-hidden="true"
                  ></span>
                </p>
