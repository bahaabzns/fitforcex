...
\restrict Wf1Bkc90w9N0pHYE5FDtTe2EZlMWbgyWtBXxgJoY0vXaJSfqDZ6taT4Dxcp5rvs
...
--
-- Name: billing_discounts; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: client_observations; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.exercise_equipments (
    ...
    name_en text CONSTRAINT exercise_equipments_name_not_null NOT NULL,
    name_ar text
);
...
CREATE TABLE public.exercise_library (
    ...
    name_en text CONSTRAINT exercise_library_name_not_null NOT NULL,
    muscle_group text,
    equipment text,
    youtube_url text,
    video_path text,
...
CREATE TABLE public.exercise_muscle_groups (
    ...
    name_en text CONSTRAINT exercise_muscle_groups_name_not_null NOT NULL,
    name_ar text
);
...
CREATE TABLE public.food_categories (
    id text NOT NULL,
    name_en character varying(100) CONSTRAINT food_categories_name_not_null NOT NULL,
    workspace_id text,
...
CREATE TABLE public.food_items (
    id text NOT NULL,
    name_en character varying(255) CONSTRAINT food_items_name_not_null NOT NULL,
...
CREATE TABLE public.form_questions (
    ...
    label_en text DEFAULT 'Question'::text CONSTRAINT form_questions_label_not_null NOT NULL,
    ...
    placeholder_ar text,
    options_ar jsonb,
    CONSTRAINT form_questions_type_check CHECK (((type)::text = ANY (ARRAY[('text'::character varying)::text, ('long_text'::character varying)::text, ('number'::character varying)::text, ('scale'::character varying)::text, ('select'::character varying)::text, ('multiselect'::character varying)::text, ('date'::character varying)::text])))
);
...
CREATE TABLE public.forms (
    id text NOT NULL,
    workspace_id text NOT NULL,
    title_en character varying(255) DEFAULT 'Untitled Form'::character varying CONSTRAINT forms_title_not_null NOT NULL,
    description_en text,
    ...
    description_ar text,
    CONSTRAINT forms_status_check CHECK (((status)::text = ANY (ARRAY[('draft'::character varying)::text, ('active'::character varying)::text])))
);
...
--
-- Name: plan_period_links; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.plan_period_links (
    id text NOT NULL,
...
CREATE TABLE public.plans (
    ...
    cta_text text DEFAULT 'Get Started'::text NOT NULL,
    cta_variant text DEFAULT 'outline'::text NOT NULL,
    features_header text DEFAULT 'What''s included:'::text NOT NULL,
    features_subheader text,
    has_team_counter boolean DEFAULT false NOT NULL,
    sort_order integer DEFAULT 0 NOT NULL,
    currency text DEFAULT 'LE'::text NOT NULL,
    show_on_landing boolean DEFAULT true NOT NULL,
    price_per_seat numeric(10,2),
    min_seat_count integer DEFAULT 1 NOT NULL,
    max_seat_count integer DEFAULT 20 NOT NULL,
    max_clients integer
);
...
--
-- Name: workspace_payments; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.workspace_payments (
    ...
    fawaterak_status text DEFAULT 'pending'::text NOT NULL,
...
--
-- Name: billing_discounts billing_discounts_period_key_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.billing_discounts
    ADD CONSTRAINT billing_discounts_period_key_key UNIQUE (period_key);


--
-- Name: billing_discounts billing_discounts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.billing_discounts
    ADD CONSTRAINT billing_discounts_pkey PRIMARY KEY (id);
...
--
-- Name: client_observations client_observations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.client_observations
...
ALTER TABLE ONLY public.exercise_equipments
    ADD CONSTRAINT exercise_equipments_coach_id_name_key UNIQUE (workspace_id, name_en);
...
ALTER TABLE ONLY public.exercise_muscle_groups
    ADD CONSTRAINT exercise_muscle_groups_coach_id_name_key UNIQUE (workspace_id, name_en);
...
--
-- Name: plan_period_links plan_period_links_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.plan_period_links
    ADD CONSTRAINT plan_period_links_pkey PRIMARY KEY (id);


--
-- Name: plan_period_links plan_period_links_plan_id_billing_discount_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.plan_period_links
    ADD CONSTRAINT plan_period_links_plan_id_billing_discount_id_key UNIQUE (plan_id, billing_discount_id);
...
--
-- Name: threads threads_workspace_client_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.threads
    ADD CONSTRAINT threads_workspace_client_unique UNIQUE (workspace_id, client_id);
...
--
-- Name: workspace_payments workspace_payments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.workspace_payments
    ADD CONSTRAINT workspace_payments_pkey PRIMARY KEY (id);
...
--
-- Name: client_observations_client_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX client_observations_client_id_index ON public.client_observations USING btree (client_id);


--
-- Name: client_observations_workspace_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX client_observations_workspace_id_index ON public.client_observations USING btree (workspace_id);
...
--
-- Name: plans_one_default; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX plans_one_default ON public.plans USING btree (is_default) WHERE (is_default = true);


--
-- Name: threads_workspace_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX threads_workspace_id_idx ON public.threads USING btree (workspace_id);


--
-- Name: threads_workspace_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX threads_workspace_id_index ON public.threads USING btree (workspace_id);


--
-- Name: workout_logs_client_id_date_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX workout_logs_client_id_date_index ON public.workout_logs USING btree (client_id, date);


--
-- Name: workout_logs_client_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX workout_logs_client_id_index ON public.workout_logs USING btree (client_id);


--
-- Name: workout_logs_plan_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX workout_logs_plan_id_index ON public.workout_logs USING btree (plan_id);


--
-- Name: workout_logs_workspace_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX workout_logs_workspace_id_index ON public.workout_logs USING btree (workspace_id);


--
-- Name: workspace_payments_fawaterak_invoice_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX workspace_payments_fawaterak_invoice_id_idx ON public.workspace_payments USING btree (fawaterak_invoice_id);


--
-- Name: workspace_payments_workspace_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX workspace_payments_workspace_id_idx ON public.workspace_payments USING btree (workspace_id);
...
--
-- Name: client_observations client_observations_author_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.client_observations
    ADD CONSTRAINT client_observations_author_id_fkey FOREIGN KEY (author_id) REFERENCES public.users(id) ON DELETE SET NULL;


--
-- Name: client_observations client_observations_client_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.client_observations
    ADD CONSTRAINT client_observations_client_id_fkey FOREIGN KEY (client_id) REFERENCES public.clients(id) ON DELETE CASCADE;


--
-- Name: client_observations client_observations_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.client_observations
    ADD CONSTRAINT client_observations_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspaces(id) ON DELETE CASCADE;
...
--
-- Name: nutrition_plans nutrition_plans_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nutrition_plans
    ADD CONSTRAINT nutrition_plans_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id) ON DELETE SET NULL;
...
--
-- Name: plan_period_links plan_period_links_billing_discount_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.plan_period_links
    ADD CONSTRAINT plan_period_links_billing_discount_id_fkey FOREIGN KEY (billing_discount_id) REFERENCES public.billing_discounts(id) ON DELETE CASCADE;


--
-- Name: plan_period_links plan_period_links_plan_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.plan_period_links
    ADD CONSTRAINT plan_period_links_plan_id_fkey FOREIGN KEY (plan_id) REFERENCES public.plans(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.training_plans
    ADD CONSTRAINT training_plans_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id) ON DELETE SET NULL;
...
--
-- Name: workout_logs workout_logs_day_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.workout_logs
    ADD CONSTRAINT workout_logs_day_id_fkey FOREIGN KEY (day_id) REFERENCES public.training_days(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.workout_logs
    ADD CONSTRAINT workout_logs_plan_id_fkey FOREIGN KEY (plan_id) REFERENCES public.training_plans(id) ON DELETE SET NULL;


--
-- Name: workout_logs workout_logs_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.workout_logs
    ADD CONSTRAINT workout_logs_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspaces(id) ON DELETE CASCADE;
...
--
-- Name: workspace_payments workspace_payments_plan_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.workspace_payments
    ADD CONSTRAINT workspace_payments_plan_id_fkey FOREIGN KEY (plan_id) REFERENCES public.plans(id);


--
-- Name: workspace_payments workspace_payments_workspace_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.workspace_payments
    ADD CONSTRAINT workspace_payments_workspace_id_fkey FOREIGN KEY (workspace_id) REFERENCES public.workspaces(id) ON DELETE CASCADE;
...
\unrestrict Wf1Bkc90w9N0pHYE5FDtTe2EZlMWbgyWtBXxgJoY0vXaJSfqDZ6taT4Dxcp5rvs

--
-- PostgreSQL database dump
--

\restrict JxJ4al7ObS5IJIGEg9MDzlsRFlCEMAcVUPUnTzYCCdAGGI4yPWpOJm8lwXwG5rj
...
1	001_baseline	2026-06-08 19:44:39.094322
27	002_add_trial_days_to_plans	2026-06-08 20:07:35.42703
28	003_add_fawaterak_payments	2026-06-08 20:07:35.430478
29	004_add_plan_payment_link	2026-06-08 20:07:35.432421
30	005_plans_landing_fields	2026-06-08 20:07:35.433949
31	006_billing_discounts_and_seat_price	2026-06-08 20:07:35.435309
32	007_plan_period_links	2026-06-08 20:07:35.438132
33	008_plans_max_clients	2026-06-08 20:07:35.440187
34	009_users_phone	2026-06-08 20:07:35.442074
35	010_add_created_by_to_plans	2026-06-08 20:07:35.443654
36	011_users_preferred_language	2026-06-08 20:07:35.444668
37	012_bilingual_content_columns	2026-06-08 20:07:35.445607
38	013_email_verification	2026-06-08 20:07:35.446308
39	014_messaging	2026-06-08 20:07:35.446955
40	015_password_reset_tokens	2026-06-08 20:07:35.44757
41	016_workout_logs	2026-06-09 01:28:55.624785
42	017_client_observations	2026-06-09 02:01:18.427468
43	018_fix_primary_keys	2026-06-09 23:56:15.112
44	019_user_sessions	2026-06-11 02:33:38.825626
45	020_fix_threads_id_types	2026-06-11 16:25:33.286224
\.
...
\unrestrict JxJ4al7ObS5IJIGEg9MDzlsRFlCEMAcVUPUnTzYCCdAGGI4yPWpOJm8lwXwG5rj
