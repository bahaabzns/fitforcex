...
/**
 * Notifications addressed to the current client, scoped to their workspace.
 * Mirrors notifications.controller.ts's recipientScope — recipient_type is
 * always 'client' here, the team-portal surface reads its own ('user') rows.
 */
...
export async function markRead(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
        ...
        // a client can never mark another client's or workspace's notification read.
