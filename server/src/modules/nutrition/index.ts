            ...
            work: async (dbClient) => {
                ...
                await dbClient.query(
                    `DELETE FROM nutrition_meals nm
                     ...
                     WHERE nm.cycle_id = nc.id AND nc.plan_id = np.id
                       AND np.workspace_id = $1 AND np.client_id = $2`,
                    [req.user!.workspaceId, clientId]
                );
                await dbClient.query(
                    ...
                    for (const cycle of normalizeOrderedList(plan.cycles as Row[], 'cycle_order') as Row[]) {
                        const insertedCycle = await dbClient.query(
                            ...
                            [
                                ...
                                cycle.goal_carbs ?? null, cycle.goal_fats ?? null,
                                createId(),
                            ]
                        );
        ...
        const result = await saveSinglePlanDraft({
            ...
            insertPlanTree: async ({ dbClient, plan: incomingPlan, clientId: cId, coachId, createdAt, updatedAt }: { dbClient: PoolClient; plan: Row; clientId: string; coachId: string; createdAt: string; updatedAt: string }) => {
                ...
                await insertOrderedChildren({
                    items:    incomingPlan.cycles as Row[],
                            ...
                            insert:   async (meal: Row) => {
                                ...
                                await insertOrderedChildren({
                                    ...
                                    insert:   async (item: Row) => {
                                        ...
                                        await insertOrderedChildren({
                                            items:    item.alternatives as Row[],
                                            orderKey: 'alt_order',
...
router.post('/plans/:id/duplicate', async (req: Request, res: Response, next: NextFunction) => {
...
router.post('/cycles/:id/duplicate', async (req: Request, res: Response, next: NextFunction) => {
    const dbClient = await pool.connect();
    try {
        await dbClient.query('BEGIN');
...
router.post('/cycles', async (req: Request, res: Response, next: NextFunction) => {
    ...
    try {
        ...
        const nextOrder = (nextOrderResult.rows[0] as Row).next_order;
...
router.put('/cycles/:id', async (req: Request, res: Response, next: NextFunction) => {
...
router.delete('/cycles/:id', async (req: Request, res: Response, next: NextFunction) => {
    try {
        const result = await pool.query(
...
router.post('/meals/:id/duplicate', async (req: Request, res: Response, next: NextFunction) => {
    const dbClient = await pool.connect();
    try {
        await dbClient.query('BEGIN');

        const mealResult = await dbClient.query(
...
router.post('/meals', async (req: Request, res: Response, next: NextFunction) => {
...
router.put('/meals/:id', async (req: Request, res: Response, next: NextFunction) => {
...
router.delete('/meals/:id', async (req: Request, res: Response, next: NextFunction) => {
    try {
        const result = await pool.query(
...
router.post('/meal-items', async (req: Request, res: Response, next: NextFunction) => {
...
router.put('/meal-items/reorder', async (req: Request, res: Response, next: NextFunction) => {
...
router.put('/meal-items/:id', async (req: Request, res: Response, next: NextFunction) => {
...
router.delete('/meal-items/:id', async (req: Request, res: Response, next: NextFunction) => {
    try {
        const result = await pool.query(
...
router.post('/meal-items/:id/alternatives', async (req: Request, res: Response, next: NextFunction) => {
...
router.put('/meal-item-alternatives/:id', async (req: Request, res: Response, next: NextFunction) => {
    const { amount } = req.body as { amount?: unknown };
    try {
        const result = await pool.query(
...
router.delete('/meal-item-alternatives/:id', async (req: Request, res: Response, next: NextFunction) => {
    try {
        const result = await pool.query(
