...
- [ ] 2026-08-23 — 19e00c0 — training — Arabic exercise/muscle/equipment names; mobile's training models have no `*_ar` fields at all (nutrition already has this). Medium.
...
**Forms**
- [ ] 2026-08-23 — dd9c85f — forms — Clients can edit a submitted answer + see edit history via a generic PATCH endpoint; mobile hard-disables all inputs post-submit with no unlock path. Medium.
